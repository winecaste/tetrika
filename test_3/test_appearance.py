...
# Подключаем функцию appearance
from solution import appearance  # Замените path_to_module на реальный путь
...
def test_appearance(intervals, expected):
    """Тестирует функцию appearance на корректность вычислений"""
    assert appearance(intervals) == expected, f"Failed on intervals: {intervals}"
